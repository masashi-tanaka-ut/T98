...
public:
  ...
  void ConstructProcess() override {
    ...
    auto pbar = G4AntiProton::Definition();
    auto pm = pbar->GetProcessManager();
...
int main(int argc,char** argv)
{
  ...
  auto actionInitialization = new B4a::ActionInitialization(detConstruction,atoi(argv[ii]));
  runManager->SetUserInitialization(actionInitialization);
  G4cout << "ii : " <<  ii <<"  Nevent1 : " << atoi(argv[ii]) << G4endl;
